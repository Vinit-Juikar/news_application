...
import 'package:news_application/api/latest_business_news_api.dart';

class BusinessNewsWidget extends StatelessWidget {
  const BusinessNewsWidget({Key? key}) : super(key: key);
  ...
  static Widget create() => const BusinessNewsWidget();
}
