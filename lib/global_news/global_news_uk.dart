...
class GlobalNewsUk extends StatefulWidget {
  const GlobalNewsUk({Key? key}) : super(key: key);

  @override
  _GlobalNewsUkState createState() => _GlobalNewsUkState();
}

class _GlobalNewsUkState extends State<GlobalNewsUk> {
  bool _loading = true;
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.network(
                        RandomImageUrlsForUk[index].toString(),fit: BoxFit.cover,
                      ),
                    ),
                  ),
                ),
