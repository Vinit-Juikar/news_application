...
class GlobalNewsUs extends StatefulWidget {
  const GlobalNewsUs({Key? key}) : super(key: key);

  @override
  _GlobalNewsUsState createState() => _GlobalNewsUsState();
}

class _GlobalNewsUsState extends State<GlobalNewsUs> {
  bool _loading = true;
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.network(
                        RandomImageUrlsForUs[index].toString(),fit: BoxFit.cover,
                      ),
                    ),
                  ),
                ),
