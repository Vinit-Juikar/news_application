...
class GlobalNewsIndia extends StatefulWidget {
  const GlobalNewsIndia({Key? key}) : super(key: key);

  @override
  _GlobalNewsIndiaState createState() => _GlobalNewsIndiaState();
}

class _GlobalNewsIndiaState extends State<GlobalNewsIndia> {
  bool _loading = true;
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.network(
                        RandomImageUrlsForIndia[index].toString(),fit: BoxFit.cover,
                      ),
                    ),
                  ),
                ),
